...
class _TeacherNotificationsScreenState
  ...
  Future<void> handleAcceptRequest(String notificationId) async {
    await FireStoreFunctions.enrollGroup(
        userId: notificationsMap[notificationId]!['senderId']!,
        groupId: notificationsMap[notificationId]!['groupId']!);
    // log(" groupId: ${notificationsMap[notificationId]!['groupId']}");
